...
import SearchBar2 from "./Sections/SearchBar2.js";
  ...
  return (
    <div>
          ...
          <GridContainer>
            <GridItem>
              <div className={classes.brand}>
                ...
                {/* <h2>Hello {currentUser.uid}</h2> */}
                <h2>Hello {currentUser.displayName}</h2>
                {/* <h2 key={user.id}>Hello {user.name}</h2> */}
                {/* <h2 >Hello {`${user.id}=>${doc.data()}`}</h2> */}
                {/* <h2 >Hello {.name}</h2> */}
                {/* <Button
                color="danger"
                size="lg"
      ...
      <div className={classes.typo} style={{textAlign: "center", padding: "18px"}} >
              ...
              <Button color="danger" href="#id1">Discover How!</Button>
            </div>
            {/* <SectionTabs /> */}
        <Element name="test1" id="id1"><SearchBar2 /></Element>
        <SectionCarousel />
        ...
        {/* <SectionExamples />nccnncncncncncncncncncncncncncncncncnncncn
        <SectionDownload /> */}
